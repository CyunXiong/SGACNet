...
if __name__ == '__main__':
    ...
    for camera in cameras:
        ...
        miou, pacc,macc, _= confusion_matrices[camera].compute_miou()
        print(f'\rCamera: {camera} mIoU: {100*miou:0.2f}')
        print(f'pacc {camera}: {pacc}'
                  )
        print(f'macc  {camera}: {macc}'
                )
    ...
    miou, pacc, macc, _= confusion_matrices['all'].compute_miou()
