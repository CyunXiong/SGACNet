...
def get_results():
    ...
    # basepath = '/home/cyxiong/SGACNet1/datasets/nyuv2/train/'
    basepath = '/home/cyxiong/SGACNet/datasets/sunrgbd/'
     
     # ?遍历所有图片
    # f=open("/home/cyxiong/SGACNet1/datasets/nyuv2/train.txt","r") #设置文件对象
    f=open("/home/cyxiong/SGACNet/datasets/sunrgbd/train_depth.txt","r")    #*depth     line1
    p=open("/home/cyxiong/SGACNet/datasets/sunrgbd/train_rgb.txt","r")   #*rgb       line0
    q=open("/home/cyxiong/SGACNet/datasets/sunrgbd/list.txt","r")
    while True:
        line1=f.readline() 
        line1 =line1 [:-1]
        line0=p.readline() #包括换行符
        line0 =line0 [:-1] #去掉换行符
        line=q.readline() #包括换行符
        line =line[:-1] #去掉换行符 
        ...
        # img_rgb =get_picture(rgb_filepath,transform)
            ...
            # q=open("/home/cyxiong/SGACNet1/datasets/sunrgbd/list.txt","r")
            # while True:
            #         line=q.readline() #包括换行符
            #         line =line [:-1] #去掉换行符
            #         if line:
            ...
            plt.savefig('/home/cyxiong/SGACNet/samples/feature/SUNRGBD_result_Our_B/'+'_'+line+'.png')
