...
def save_ckpt_every_epoch(ckpt_dir, model, optimizer, epoch, best_miou,
    ...
    state = {
        ...
        # *pacc macc
        'best_pacc': best_pacc,
        'best_pacc_epoch': best_pacc_epoch,
        'best_pacc': best_macc,
        'best_pacc_epoch': best_macc_epoch,
    }
...
def load_ckpt(model, optimizer, model_file, device):
    if os.path.isfile(model_file):
        ...
        return epoch, best_miou, best_miou_epoch, best_pacc, best_pacc_epoch, best_macc, best_macc_epoch
...
def get_best_checkpoint(ckpt_dir, key='mIoU_test', key1='pacc_test', key2='macc_test'):
    ckpt_path = None
