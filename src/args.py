    ...
    def set_common_args(self):
        ...
        self.add_argument('--batch_size_valid', type=int, default=None,
                          help='batch size for validation. Can be typically '
                               ...
                               '--batch_size.')
        self.add_argument('--height', type=int, default=480,#480,
                          help='height of the training images. '
                               'Images will be resized to this height.')
        self.add_argument('--width', type=int, default=640,#640,
        ...
        self.add_argument('--encoder', type=str, default='resnet18',
        ...
        self.add_argument('--encoder_block', type=str,
                          ...
                          help='The block that is used in the ResNet encoder.'
                               ...
                               'results than the BasicBlock.') #NonBottleneck1D,BRUBlock,SS_nbt_module,DABModule
     #    self.add_argument('--encoder_block', type=str,
     #                      default='BRUBlock',
     #                      choices=['BasicBlock', 'BRUBlock'],
     #                      help='The block that is used in the ResNet encoder.'
     #                           'The BRUBlock achieves better '
     #                           'results than the BasicBlock.') #NonBottleneck1D,BRUBlock,SS_nbt_module,DABModule       
        ...
        self.add_argument('--context_module', type=str, default='appm',
                          choices=['ppm', 'None', 'ppm-1-2-4-8', 'appm',#*sppm,dappm,ppm,appm
                                   'appm-1-2-4-8'],
...
#           #* recalibration type
#         self.add_argument('--recalibration-type', type=str, metavar='recalibration',
